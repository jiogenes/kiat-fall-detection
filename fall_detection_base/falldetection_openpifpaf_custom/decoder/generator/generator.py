    ...
    def fields_batch(model, image_batch, *, device=None):
        ...
        with torch.no_grad():
            ...
            with torch.autograd.profiler.record_function('model'):
                ...
                # print(1, type(heads), len(heads), type(heads[0]), type(heads[1]), heads[0].shape, heads[1].shape)
        ...
        # print(2, type(heads), len(heads), type(heads[0][0]), heads[0][0].shape)
        # print(2, type(heads), len(heads), type(heads[0]), type(heads[1]), heads[0].shape, heads[1].shape)
        return heads
